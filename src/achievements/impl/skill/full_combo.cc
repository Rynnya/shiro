...
#include "full_combo.hh"

 // This value must be added to ID's
constexpr size_t achievement_offset = 72;
...
void shiro::achievements::full_combo::verify(
...
float shiro::achievements::full_combo::get_difficulty(const shiro::beatmaps::beatmap& beatmap) {

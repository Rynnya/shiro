...
#ifndef SHIRO_ACHIEVEMENT_FULL_COMBO_HH
#define SHIRO_ACHIEVEMENT_FULL_COMBO_HH

#include "../../achievement.hh"

namespace shiro::achievements {

    class full_combo : public shiro::achievements::achievement {
    public:
        void verify(
    ...
    private:
        float get_difficulty(const shiro::beatmaps::beatmap& beatmap);
    };
}

...
#if defined(_SSE2_AVAILABLE) && defined(_AES_NI_AVAILABLE) && defined(_AVX2_AVAILABLE)
...
#endif // defined(_SSE2_AVAILABLE) && defined(_AES_NI_AVAILABLE) && defined(_AVX2_AVAILABLE)
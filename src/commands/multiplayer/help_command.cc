...
bool shiro::commands_mp::help(std::deque<std::string>& args, std::shared_ptr<shiro::users::user> user, std::string channel) {
    ...
    utils::bot::respond("!mp size - Changes size of lobby (max 16)", user, channel, true);

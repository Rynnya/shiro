...
bool shiro::commands::relax(std::deque<std::string>& args, const std::shared_ptr<shiro::users::user>& user, const std::string& channel) {
...
bool shiro::commands::classic(std::deque<std::string>& args, const std::shared_ptr<shiro::users::user>& user, const std::string& channel) {
    if (!user->is_relax) {
